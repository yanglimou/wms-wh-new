...
public abstract class BaseRecordOut<M extends BaseRecordOut<M>> extends Model<M> implements IBean {
	...
	public M setPatientNo(String patientNo) {
		set("patientNo", patientNo);
		return (M)this;
	}

	public String getPatientNo() {
		return getStr("patientNo");
	}
